...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_authService__ = __webpack_require__("../../../../../src/app/services/authService.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_logLevel__ = __webpack_require__("../../../../../src/app/models/logLevel.ts");
...
var SettingsViewComponent = (function () {
    function SettingsViewComponent(router, route, location, settingsService, toastr, authService) {
        this.router = router;
        this.route = route;
        this.location = location;
        ...
        this.toastr = toastr;
        this.authService = authService;
        this.logLevelsEnum = __WEBPACK_IMPORTED_MODULE_7__models_logLevel__["a" /* LogLevel */];
    }
    SettingsViewComponent.prototype.onSubmitPassword = function () {
        var _this = this;
        // validate
